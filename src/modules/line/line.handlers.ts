...
function welcomeMessage(): Message {
  return {
    ...
    text: [
      "สวัสดีคุณ Siwakon",
      "ยินดีต้อนรับสู่ Lowest - caron 🌿 ผู้ช่วยดูแลไลฟ์สไตล์สีเขียวของคุณบน LINE",
      "",
      "ที่นี่คุณสามารถ",
      "• บันทึกการเดินทาง อาหาร และกิจกรรม แล้วให้ระบบคำนวณคาร์บอนให้อัตโนมัติ",
      "• ขอ “แผนวันนี้” เพื่อรับคำแนะนำลดคาร์บอนแบบเฉพาะตัว",
      "• สะสมแต้มเพื่อนำไปแลกรางวัลดีต่อใจ",
      "",
      "เริ่มต้นง่าย ๆ",
      "– เปิด Mini App เพื่อเข้าสู่ระบบและเริ่มบันทึกกิจกรรม",
      '– หรือพิมพ์คำสั่งได้ทันที: “แต้ม”, “กิจกรรม”, “รางวัล”, “แผนวันนี้”',
      "",
      "ถ้ามีอะไรสงสัย ส่งข้อความมาหาเราได้เลยนะครับ ✨",
    ].join("\n"),
  }
}
